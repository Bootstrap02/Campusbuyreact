  ...
  return (
    <div>
      ...
      <div className='flex flex-col gap-3 m-2 px-2 py-4  max-lg:m-0 max-lg:p-0'>
        <Wishlistcards isCheckedList={isCheckedList} onCheckboxToggle={handleCheckboxToggle} />
      </div>
      ...
      <div className='flex flex-col gap-3   '>
        <Wishlistmobilecards isCheckedList={isCheckedList} onCheckboxToggle={handleCheckboxToggle} />
      </div>
